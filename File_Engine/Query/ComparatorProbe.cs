...
namespace BH.Engine.Adapters.File
{
    public static partial class Query
    {
        ...
        [Description("Counts the pull configurations provided. Validation probe only.")]
        [Input("configs", "Pull configurations to count.")]
        [Output("count", "Number of configurations provided.")]
        public static int ComparatorProbeConfigCount(PullConfig[] configs)
        {
